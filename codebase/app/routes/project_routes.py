...
@router.post(
    "/projects", response_model=schemas.ProjectRead, status_code=status.HTTP_201_CREATED
)
...
@router.get(
    ...
    response_model=schemas.TaskPagination,
    status_code=status.HTTP_200_OK,
)
async def list_tasks_by_project_id(
    project_id: uid.UUID,
    skip: int = 0,
    limit: int = 100,
